...
var AutoFocus = function (id_inputDay, id_inputMonth, id_inputYear, id_inputDni) {
  ...
  var campoMes = document.getElementById(id_inputMonth)
  var campoAnho = document.getElementById(id_inputYear)
  var campoDNI = document.getElementById(id_inputDni)

  this.saltoInput = function (campo) {
    var campoActual = campo.id
    var numDigitos = campo.value.length
    var charCode = (campo.which) ? campo.which : campo.keyCode
    var nextInput
